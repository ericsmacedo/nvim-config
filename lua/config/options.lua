...
-- Enable line numbers and relative numbers by default
vim.o.number = true
...
vim.wo.colorcolumn = "88"	  -- columnt to indicate end of 80 characters
vim.wo.conceallevel = 0       -- Determine how text with the "conceal" syntax attribute :syn-conceal is shown
